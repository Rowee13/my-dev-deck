...
export default function ProjectSettingsPage() {
  ...
  const handleDelete = async () => {
    ...
    if (!confirm(`Are you sure you want to delete "${project.name}"? This will permanently delete all emails associated with this project. This action cannot be undone.`)) {
      return;
    }
      ...
      <div className="space-y-8">
        ...
        <section className="bg-white rounded-lg shadow p-6">
          ...
          <div className="flex items-center space-x-3 mb-4">
            <code className="flex-1 text-lg bg-gray-100 px-4 py-3 rounded-md font-mono">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
            <p className="text-sm text-blue-900 mb-2">
              <strong>Any email address</strong> at this domain will appear in your inbox:
            </p>
          ...
          <div className="space-y-4">
            <div className="p-4 border-2 border-dashed border-gray-300 rounded-md">
              ...
              <p className="text-sm text-gray-500">
                Automatically delete emails after a specified number of days (Coming Soon)
              </p>
            </div>
            <div className="p-4 border-2 border-dashed border-gray-300 rounded-md">
        ...
        <section className="bg-white rounded-lg shadow p-6 border-2 border-red-200">
          ...
          <p className="text-gray-600 mb-4">
            Deleting this project will permanently remove all associated emails and data. This action cannot be undone.
          </p>
          <button
